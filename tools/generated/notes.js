...
**Agents and the harness.** What a model is and is not, the context, the harness, skills, hooks, MCP, subagents, security and cost. [[LLM versus harness]], [[Context window and prompts]], [[AGENTS.md]], [[Your harness: AGENTS.md, CLAUDE.md, dotfiles for agents]], [[Agent Skills standard]], [[Hook]], [[MCP]], [[Security and permissions]], [[Cost, tokens and model choice]], [[Agent hooks]], [[Subagents and multi-agent]]
