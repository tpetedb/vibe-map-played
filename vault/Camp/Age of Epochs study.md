...
What Vibe Code Camp learned from sokrypton/aoe, a browser Age of Empires built with Claude Code. Ideas only: that repo is GPL-2.0-or-later and this one is MIT, so no code or art crosses over.
