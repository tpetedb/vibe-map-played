// Dates and pairings come from grimoire.toml through the build (CONFIG); the
...
function renderMsg(){if(!S.date||!S.wine){$("msgcard").style.display="none";return}const c=S.creature?S.creature.name:"an unnamed agent";
